...
Mapa estático de dependencias basado en `law_functions`.
...
- `fn_src_mlp_ws_dispatch`
  - `fn_src_mlp_pipeline_runs_all`
- `fn_src_mlp_ws_drillit`
  - `fn_src_mlp_pipeline_runs_all`
- `fn_src_mlp_ws_blkgrde`
  - `fn_src_mlp_pipeline_runs_all`
- `fn_src_mlp_ws_meteo`
  - `fn_src_mlp_systemlogs_all`
- `fn_src_mlp_ws_plans`
...
- `fn_prd_mlp_ada_dom_blockgrade_status` → `fn_src_mlp_pipeline_runs_all`, `fn_src_mlp_ws_ada`
...
- `fn_prd_mlp_ada_dom_kpi_status` → `fn_src_mlp_systemlogs_all`
- `fn_prd_mlp_ada_alert_from_dispatch_nrt_logs` → `fn_src_mlp_ws_ada`
- `fn_prd_mlp_ada_kpi_alert_rows` → `fn_src_mlp_ws_ada`
...
2. `fn_src_mlp_ws_ada` (6 consumidores directos; incluye source agregador)
...
- **Solo ADA**: `fn_src_mlp_ws_ada`, `fn_src_mlp_ws_dispatch`, `fn_src_mlp_ws_drillit`, `fn_src_mlp_ws_blkgrde`, `fn_src_mlp_ws_meteo`, `fn_src_mlp_pipeline_runs_all`, `fn_src_mlp_systemlogs_all`
...
- **Compartidos entre productos**: `fn_src_mlp_ws_pisystem`, `fn_src_mlp_ws_plans`

## 6) Agregadores que dependen de múltiples workspace sources

- `fn_src_mlp_pipeline_runs_all`
  - depende de `fn_src_mlp_ws_dispatch`, `fn_src_mlp_ws_drillit`, `fn_src_mlp_ws_blkgrde`
- `fn_src_mlp_systemlogs_all`
  - depende de `fn_src_mlp_ws_ada`, `fn_src_mlp_ws_meteo`, `fn_src_mlp_ws_pisystem`, `fn_src_mlp_ws_plans`
- `fn_src_mlp_ssag_systemlogs_all`
  - depende de `fn_src_mlp_ws_ssag`, `fn_src_mlp_ws_plans`, `fn_src_mlp_ws_pdmsagi`, `fn_src_mlp_ws_pisystem`
